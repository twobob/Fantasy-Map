...
namespace Janphe.Fantasy.Map
{
    partial class Map6Religions
    {
        ...
        static readonly JObject @base = JObject.Parse(@"{
          ...
          genitive: ['Day', 'Life', 'Death', 'Night', 'Home', 'Fog', 'Snow', 'Winter', 'Summer', 'Cold', 'Springs', 'Gates', 'Nature', 'Thunder', 'Lightning', 'War', 'Ice', 'Frost', 'Fire', 'Doom', 'Fate', 'Pain', 'Heaven', 'Justice', 'Light3D', 'Love', 'Time', 'Victory'],
          ...
          color: ['Dark', 'Light3D', 'Bright', 'Golden', 'White', 'Black', 'Red', 'Pink', 'Purple', 'Blue', 'Green', 'Yellow', 'Amber', 'Orange', 'Brown', 'Grey']
        }");
